            ...
            __helper: {
                get() {
                    if (!this[entityHelperSymbol]) {
                        this[entityHelperSymbol] = new WrappedEntity_1.WrappedEntity(this, em.getComparator().getPkGetter(meta), em.getComparator().getPkSerializer(meta), em.getComparator().getPkGetterConverted(meta));
                    }
